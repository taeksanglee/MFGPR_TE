This code and data implement results shown in the manuscript entitled "Multi-fidelity Gaussian process surrogate modeling of pediatric tissue expansion", which is now in revision.
